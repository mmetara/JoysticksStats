...
fun SplashScreen(navController: NavController) {
    ...
    val quotes = listOf(
        "Frappe comme si c'était la dernière manche!",
        "Un retrait à la fois.",
        "Les stats ne mentent jamais.",
        "Chaque lancer compte.",
        "Joue comme un champion.",
        "La victoire se prépare ici.",
        "Focus sur le prochain jeu.",
        "Le terrain n’attend pas.",
        "Donne tout à chaque présence.",
        "C’est ton moment."
    )
